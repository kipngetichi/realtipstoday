...
$whatsappLink = 'https://wa.me/25471380429?text=Hello%20Realtime%20Tips%2C%20I%20want%202%20Draws%20tips.';
...
<head>
    ...
    <meta name="description" content="Get our 2 Draws Tips package — 15+ odds safe draws, daily picks, instant delivery via SMS/WhatsApp after payment. Multiple payment options available.">
    <title>2 Draws Tips — Realtime Tips</title>
    ...
    <style>
        ...
        * {
        ...
        @keyframes pulse-blue {
            0%, 100% { transform: scale(1); box-shadow: 0 3px 10px rgba(14, 165, 233, 0.35); }
            50% { transform: scale(1.05); box-shadow: 0 5px 15px rgba(14, 165, 233, 0.5); }
        }
    ...
    <header class="hero-wrap">
        <div class="container hero">
            <section>
                ...
                <h1>2 Draws Tips<br>15+ Odds Safe Draws</h1>
                <p style="color: rgba(255,255,255,0.85); font-size: 1.1rem; margin-top: 1rem; max-width: 55ch;">
                    Get reliable draw predictions with 15+ odds. Perfect for safer betting with higher returns on your stakes.
                </p>
            </section>
                <aside class="hero-card">
                    ...
                    <ul>
                        ...
                        <li>Detailed analysis included</li>
    ...
    <main>
        <div class="container">
            ...
            <section class="trust-section">
                <div class="trust-box">
                    <span style="background: #0ea5e9; color: white; padding: 0.3rem 1rem; border-radius: 999px; font-size: 0.75rem; font-weight: 900; text-transform: uppercase; letter-spacing: 1px; display: inline-block; margin-bottom: 0.5rem;">Strategic Pick</span>
                    <h3>2 Draws Tips</h3>
                    <div class="price">Ksh 325 <span>/ day</span></div>
                    <p style="color: #075985; margin: 0.5rem 0 0; font-size: 0.95rem;">15+ odds safe draw predictions for consistent wins</p>

                     <ul>
                         <li>Two draw matches daily</li>
                         <li>15+ odds guaranteed</li>
                         <li>Pay Till (Buy Goods): <span class="inline-pay-till-copy" style="cursor: pointer; font-family: 'Courier New', monospace; font-weight: 900; font-size: 1.1rem; color: white; background: linear-gradient(135deg, #0ea5e9 0%, #0284c7 50%, #0369a1 100%); padding: 0.3rem 0.7rem; border-radius: 6px; letter-spacing: 0.5px; text-shadow: 0 1px 2px rgba(0,0,0,0.2); box-shadow: 0 3px 10px rgba(14, 165, 233, 0.35); transition: all 0.2s ease;" data-pay-till="5438677">5438677</span> <small style="color: #075985; font-weight: 600; font-size: 0.75rem;">(Click to copy)</small></li>
                         <li>Detailed analysis included</li>
                         <li>24/7 support available</li>
                     </ul>

                     <a class="cta-main" href="../M-PESAstkpush/stkpush2draws.php" target="_blank" rel="noopener noreferrer">
                         Get 2 Draws Tips Now
                     </a>
                </div>
            </section>
            ...
            <section class="payment-section">
                ...
                <div class="payment-grid">
                    <div class="payment-card pay-till">
                        <span class="recommended-badge" style="background: #0ea5e9; color: white; padding: 0.25rem 0.75rem; border-radius: 999px; font-size: 0.7rem; font-weight: 900; text-transform: uppercase; letter-spacing: 0.5px; display: inline-block; margin-bottom: 0.5rem;">Recommended</span>
            ...
            <section class="features-section">
                <h2 class="section-title">Why Choose 2 Draws Tips?</h2>
                <div class="features-grid">
                    <div class="feature-card">
                        <h4>🎯 Safe Draw Predictions</h4>
                        <p>Two carefully selected draw matches daily with 15+ total odds for balanced risk and reward.</p>
                    </div>
                    <div class="feature-card">
                        <h4>📊 Detailed Analysis</h4>
                        <p>Get in-depth match analysis to understand why each draw was selected.</p>
                    </div>
                    <div class="feature-card">
                    ...
                    <div class="feature-card">
                        ...
                        <p>Direct line to our support team for any questions or assistance.</p>
                    </div>
                    <div class="feature-card">
                    ...
                    <div class="feature-card">
                        <h4>📈 Higher Odds</h4>
                        <p>15+ odds means bigger returns on your stakes compared to regular tips.</p>
                    </div>
                </div>
            </section>
            ...
            <section class="faq-section">
                ...
                <div class="faq-item">
                    ...
                    <p>2 Draws Tips operates 7 days a week including weekends when draws are available.</p>
                </div>
            </section>

            <div class="guarantee-banner">
                <strong>🔒 100% Money-Back Guarantee</strong>
                <p style="margin: 0.5rem 0 0; color: #075985;">If our 2 Draws tips don't deliver, we refund your money — no questions asked.</p>
            </div>

            <div style="text-align: center; margin-top: 2rem;">
                <a class="cta-main" href="../M-PESAstkpush/stkpush2draws.php" target="_blank" rel="noopener noreferrer">
                    Get 2 Draws Tips — Ksh 325/day
                </a>
            </div>
        </div>
    </main>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateElement(element) {
                ...
                element.style.background = 'linear-gradient(135deg, #0284c7 0%, #0369a1 100%)';
