...
$whatsappLink = 'https://wa.me/25471380429?text=Hello%20Realtime%20Tips%2C%20I%20want%202%20odds%20daily%20tips.';
...
<head>
    ...
    <meta name="description" content="Get our 2 + odds daily package — consistent daily profits, instant delivery via SMS/WhatsApp after payment. Multiple payment options available.">
    <title>2 + odds — Realtime Tips</title>
    ...
    <style>
        ...
        * {
        ...
        .hero-wrap {
            background:
                radial-gradient(circle at 15% 20%, rgba(16, 185, 129, 0.24), transparent 42%),
                radial-gradient(circle at 85% 0%, rgba(37, 99, 235, 0.18), transparent 35%),
        ...
        @keyframes pulse-green {
            0%, 100% { transform: scale(1); box-shadow: 0 3px 10px rgba(16, 185, 129, 0.35); }
            50% { transform: scale(1.05); box-shadow: 0 5px 15px rgba(16, 185, 129, 0.5); }
        }
    ...
    <header class="hero-wrap">
        <div class="container hero">
            <section>
                ...
                <h1>2 + odds Daily<br>Consistent Daily Profits</h1>
                <p style="color: rgba(255,255,255,0.85); font-size: 1.1rem; margin-top: 1rem; max-width: 55ch;">
                    Get reliable 2-odds accumulator tips for consistent daily wins. Perfect for steady, sustainable profits.
                </p>
            </section>
                <aside class="hero-card">
                    <h2>What You Get</h2>
                    <ul>
                        <li>Curated 2-odds accumulator daily</li>
                        <li>Send via SMS or WhatsApp after payment</li>
                        <li>7 days a week service</li>
                        <li>Instant WhatsApp alerts included</li>
                    </ul>
                </aside>
        </div>
    </header>
    ...
    <main>
        <div class="container">
            ...
            <section class="trust-section">
                <div class="trust-box">
                    <span style="background: #10b981; color: white; padding: 0.3rem 1rem; border-radius: 999px; font-size: 0.75rem; font-weight: 900; text-transform: uppercase; letter-spacing: 1px; display: inline-block; margin-bottom: 0.5rem;">Best Value</span>
                    <h3>2 + odds Daily</h3>
                    <div class="price">Ksh 100 <span>/ day</span></div>
                    <p style="color: #065f46; margin: 0.5rem 0 0; font-size: 0.95rem;">Consistent daily profits with proven 2-odds accumulators</p>

                     <ul>
                         <li>2 accumulator odds guaranteed daily</li>
                         <li>High success rate</li>
                         <li>Pay Till (Buy Goods): <span class="inline-pay-till-copy" style="cursor: pointer; font-family: 'Courier New', monospace; font-weight: 900; font-size: 1.1rem; color: white; background: linear-gradient(135deg, #10b981 0%, #059669 50%, #047857 100%); padding: 0.3rem 0.7rem; border-radius: 6px; letter-spacing: 0.5px; text-shadow: 0 1px 2px rgba(0,0,0,0.2); box-shadow: 0 3px 10px rgba(16, 185, 129, 0.35); transition: all 0.2s ease;" data-pay-till="5438677">5438677</span> <small style="color: #065f46; font-weight: 600; font-size: 0.75rem;">(Click to copy)</small></li>
                         <li>Instant WhatsApp alerts</li>
                         <li>7-days-a-week service</li>
                     </ul>

                     <a class="cta-main" href="../M-PESAstkpush/stkpush2odds.php" target="_blank" rel="noopener noreferrer">
                         Get 2 + odds Now
                     </a>
                </div>
            </section>
            ...
            <section class="payment-section">
                ...
                <div class="payment-grid">
                    <div class="payment-card pay-till">
                        <span class="recommended-badge" style="background: #10b981; color: white; padding: 0.25rem 0.75rem; border-radius: 999px; font-size: 0.7rem; font-weight: 900; text-transform: uppercase; letter-spacing: 0.5px; display: inline-block; margin-bottom: 0.5rem;">Recommended</span>
            ...
            <section class="features-section">
                <h2 class="section-title">Why Choose 2 + odds Daily?</h2>
                <div class="features-grid">
                    <div class="feature-card">
                        <h4>📊 Consistent Profits</h4>
                        <p>Our 2-odds accumulators are designed for steady, sustainable daily wins without high risk.</p>
                    </div>
                    <div class="feature-card">
                        <h4>⚡ Instant Delivery</h4>
                        <p>Tips sent via SMS or WhatsApp immediately after payment confirmation.</p>
                    </div>
                    <div class="feature-card">
                        <h4>🎯 2-Odds Accumulators</h4>
                        <p>Curated 2-match combinations with 2+ total odds for balanced risk-reward.</p>
                    </div>
                    <div class="feature-card">
                        <h4>💬 Instant Alerts</h4>
                        <p>Get notified instantly via WhatsApp when your daily tips are ready.</p>
                    </div>
                    <div class="feature-card">
                        <h4>📅 7 Days a Week</h4>
                        <p>Service available every day including weekends for continuous winning opportunities.</p>
                    </div>
                    <div class="feature-card">
                        <h4>🔒 Money-Back Guarantee</h4>
                        <p>If our tips don't deliver, we offer a full refund — no questions asked.</p>
                    </div>
                </div>
            </section>
            ...
            <section class="faq-section">
                ...
                <div class="faq-item">
                    ...
                    <p>After payment confirmation, send us your payment details via WhatsApp. You'll instantly receive tips via SMS or WhatsApp.</p>
                </div>
                <div class="faq-item">
                ...
                <div class="faq-item">
                    ...
                    <p>Yes! If the tips don't meet our accuracy standards, we'll refund your payment within 24 hours.</p>
                </div>
                <div class="faq-item">
                    <h4>Do you work on weekends?</h4>
                    <p>2 + odds Daily operates 7 days a week, including weekends, for continuous winning opportunities.</p>
                </div>
            </section>

            <div class="guarantee-banner">
                <strong>🔒 100% Money-Back Guarantee</strong>
                <p style="margin: 0.5rem 0 0; color: #065f46;">If our 2 + odds tips don't deliver, we refund your money — no questions asked.</p>
            </div>

            <div style="text-align: center; margin-top: 2rem;">
                <a class="cta-main" href="../M-PESAstkpush/stkpush2odds.php" target="_blank" rel="noopener noreferrer">
                    Get 2 + odds — Ksh 100/day
                </a>
            </div>
        </div>
    </main>
