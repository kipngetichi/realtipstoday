...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .container { width: min(1200px, 92%); margin: 0 auto; padding: 0 1rem; }
        .nav-wrap {
        ...
        .nav-logo span:last-child { color: var(--white); }
        ...
        .tip-card .icon { font-size: 3rem; margin-bottom: 1rem; }
        .tip-card h3 {
            margin: 0 0 0.75rem;
            font-size: 1.5rem;
            color: var(--text-main);
        ...
        .tip-card .cta:hover { text-decoration: underline; }
        ...
        .feature-item h4 { margin: 0 0 0.5rem; color: var(--text-main); }
        .feature-item p { color: var(--text-soft); margin: 0; font-size: 0.95rem; }
        .cta-section {
        ...
        .cta-section h2 { margin: 0 0 2rem; font-size: 2.5rem; }
        .footer {
            background: var(--bg-dark);
    ...
    <nav class="nav-wrap">
        <div class="container nav-container">
            ...
            <div class="nav-menu">
                ...
                <a href="Jptips/index.php" class="nav-link">Jackpot</a>
                <a href="testimonial/index.php" class="nav-link">Testimonials</a>
                <a href="support/how-it-works.php" class="nav-link">How It Works</a>
                <a href="support/contact-us.php" class="nav-link">Contact</a>
            </div>
        </div>
    </nav>
    ...
    <main>
        <section class="section">
            <div class="container">
                ...
                <div class="tips-grid">
                    ...
                    <a href="Jptips/index.php" class="tip-card">
                        <div class="icon">💰</div>
                        <h3>Jackpot Tips</h3>
        ...
        <section class="section cta-section">
            <div class="container">
                ...
                <a href="support/contact-us.php" class="cta-button" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);">Get Started Now</a>
            </div>
        </section>
    </main>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-links">
                ...
                <a href="Jptips/index.php">Jackpot</a>
                <a href="testimonial/index.php">Testimonials</a>
