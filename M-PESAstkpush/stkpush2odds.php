...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['phone_number'])) {
    ...
    if (!$isValid) {
        ...
        $accountReference = '2ODDS-' . date('Ymd-His');
        $description = 'Payment for 2 + odds Daily - Ksh ' . $AMOUNT;
...
<head>
    ...
    <title>MPESA Payment - 2 + odds Daily</title>
...
<body>
    <div class="container">
        ...
        <h1 class="title">2 + odds Daily</h1>
        <p class="subtitle">Unlock <strong>consistent daily profits</strong> with 2-odds accumulator tips.</p>
